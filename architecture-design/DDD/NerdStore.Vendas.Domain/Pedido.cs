...
namespace NerdStore.Vendas.Domain
{
    ...
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        // Only the Pedido class can operate on it's items
        ...
        // The aggregation root has the responsability to update the children Item
        ...
        // Nested class to use as a factory for Pedido
