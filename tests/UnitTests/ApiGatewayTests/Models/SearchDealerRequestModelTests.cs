...
namespace IDSIM.Services.UnitTest.ApiGatewayTests.Models
{
    ...
    public class SearchDealerRequestModelTests : IClassFixture<UnitApiTestsFixture>
    {
        private readonly UnitApiTestsFixture _unitApiTestsFixture;

        public SearchDealerRequestModelTests(UnitApiTestsFixture unitApiTestsFixture)
        {
        ...
        {
            // Arrange
            var validModel = _unitApiTestsFixture.GetValidSearchDealerRequestModel();
        ...
        {
            // Arrange
            var validModel = _unitApiTestsFixture.GetInvalidSearchDealerRequestModel();
